...
CONF_HIGH_SPEED_MODE = "high_speed_mode"
...
CONFIG_SCHEMA = cv.Schema(
    {
        ...
        cv.Optional(CONF_HIGH_SPEED_MODE, default=False): cv.boolean,
...
async def to_code(config):
    ...
    cg.add(var.set_high_speed_mode(config[CONF_HIGH_SPEED_MODE]))
